...
# Usage:
#   openpose_list_unique(<list_variable> [<list_variable>] [...])
macro(openpose_list_unique)
  foreach(__lst ${ARGN})
    if(${__lst})
...
# Usage:
#   openpose_convert_absolute_paths(<list_variable>)
function(openpose_convert_absolute_paths variable)
  set(__dlist "")
...
# Usage:
#   openpose_option(<option_variable> "doc string" <initial value or boolean expression> [IF <condition>])
function(openpose_option variable description value)
  set(__value ${value})
  set(__condition "")
...
macro(caffe_warnings_disable)
  ...
  openpose_clear_vars(_flag_vars _msvc_warnings _gxx_warnings)
endmacro()
